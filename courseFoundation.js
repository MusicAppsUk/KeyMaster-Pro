...
export const FOUNDATION_STEPS = [
  ...
  },
  {
    ...
    hint: 'You\u2019re close. This note sits in a space, not on a line \u2014 and the spaces spell FACE from the bottom: F, A, C, E.',
    reteach: 'Count the spaces upward \u2014 F, A, C, E \u2014 and find where this one sits.',
    support: { highlight: [72] },
  },
  {
    ...
    hint: 'Close. This note sits on a line, not in a space \u2014 and the lines run E, G, B, D, F from the bottom.',
    reteach: 'Count the lines upward \u2014 E, G, B, D, F \u2014 and find where this one sits.',
    support: { highlight: [71] },
  },
  {
  ...
  {
    eyebrow: 'Reading by shape', title: 'A step', id: 'shape-step',
    say: [
      { text: 'First, a step. A step moves to the very next note \u2014 from a line to the space just above it, or a space to the next line.', pauseAfter: 620, tone: 'warm' },
      { text: 'Here are two notes a step apart. Listen, then play them.', pauseAfter: 320, tone: 'instruct' },
    ],
    explain: ['A step moves to the very next note \u2014 line to the space above, or space to the next line.', 'Hear the two notes a step apart, then play them in order, low to high.'],
    show: { kind: 'staff', clef: 'treble', notes: [ { midi: 64, value: 'whole' }, { midi: 65, value: 'whole' } ], caption: 'A step \u2014 to the very next note.' },
    demo: [64, 65], demoGap: 0.5,
    tryPrompt: 'Play the two notes you see, low to high \u2014 a step apart.',
    targets: [64, 65], mode: 'sequence',
    okMsg: 'Yes \u2014 a step, to the next note up. The smallest move on the staff.',
    hint: 'You\u2019re close \u2014 look at the distance. A step moves to the very next note, with no gap. Play the lower note, then the one just above.',
    reteach: 'This is a step, the smallest move on the staff \u2014 just one note higher.',
    support: { highlight: [64, 65], replay: true },
  },
  {
    eyebrow: 'Reading by shape', title: 'A skip', id: 'shape-skip',
    say: [
      { text: 'Next, a skip. A skip jumps over one note \u2014 from a line to the next line, or a space to the next space.', pauseAfter: 620, tone: 'warm' },
      { text: 'Hear the wider gap, then play it.', pauseAfter: 320, tone: 'instruct' },
    ],
    explain: ['A skip jumps over the note in between \u2014 line to the next line, or space to the next space.', 'Hear the wider gap of a skip, then play the two notes in order.'],
    show: { kind: 'staff', clef: 'treble', notes: [ { midi: 64, value: 'whole' }, { midi: 67, value: 'whole' } ], caption: 'A skip \u2014 jumping over one note.' },
    demo: [64, 67], demoGap: 0.5,
    tryPrompt: 'Play the two notes you see \u2014 a skip apart, low to high.',
    targets: [64, 67], mode: 'sequence',
    okMsg: 'Yes \u2014 a skip leaps over the note between. Line to line, or space to space.',
    hint: 'Close \u2014 listen to the gap. A skip leaps over one note, wider than a step. Play the lower note, then jump over one.',
    reteach: 'This is a skip \u2014 from a line to the next line, leaping over the note between.',
    support: { highlight: [64, 67], replay: true },
  },
  {
    eyebrow: 'Reading by shape', title: 'A repeat', id: 'shape-repeat',
    say: [
      { text: 'And a repeat is the simplest of all \u2014 the same note again, in the very same place.', pauseAfter: 600, tone: 'warm' },
      { text: 'Play that note twice.', pauseAfter: 320, tone: 'instruct' },
    ],
    explain: ['A repeat is the same note played again, in the same place on the staff.', 'Hear the note, then play it twice.'],
    show: { kind: 'staff', clef: 'treble', notes: [ { midi: 67, value: 'whole' }, { midi: 67, value: 'whole' } ], caption: 'A repeat \u2014 the same note again.' },
    demo: [67, 67], demoGap: 0.5,
    tryPrompt: 'Play the same note twice \u2014 a repeat.',
    targets: [67, 67], mode: 'sequence',
    okMsg: 'Yes \u2014 the same note repeated. No move at all, just played again.',
    hint: 'Almost \u2014 listen again. Both notes are the same. Play that note, then play it once more.',
    reteach: 'A repeat is the same note twice, in the same place \u2014 no move at all.',
    support: { highlight: [67], replay: true },
  },
  {
    eyebrow: 'Reading by shape', title: 'A little shape', id: 'first-shape-pattern',
    say: [
      { text: 'Now put them together. Here is a tiny shape \u2014 a step down, the same note again, then a skip down.', pauseAfter: 640, tone: 'warm' },
      { text: 'Hear it as one little phrase, then play it.', pauseAfter: 320, tone: 'instruct' },
    ],
    explain: ['A short shape combining a step, a repeat, and a skip: down a step, the same note again, then a skip down to G.', 'Read it as one phrase, not four separate notes \u2014 then play it.'],
    show: { kind: 'staff', clef: 'treble', notes: [ { midi: 72, value: 'whole' }, { midi: 71, value: 'whole' }, { midi: 71, value: 'whole' }, { midi: 67, value: 'whole' } ], caption: 'A little shape: step down, repeat, then a skip down.' },
    demo: [72, 71, 71, 67], demoGap: 0.42,
    tryPrompt: 'Play the shape: down a step, the same note again, then a skip down to G.',
    targets: [72, 71, 71, 67], mode: 'sequence',
    okMsg: 'That sounded like music \u2014 because you read the shape, not four separate notes. That is how real reading feels.',
    hint: 'Good direction \u2014 read it as one shape: down a step, the same note again, then a skip down.',
    reteach: 'Take it in pieces \u2014 down a step, repeat that note, then a skip down to the last note.',
    support: { highlight: [72, 71, 67], replay: true },
  },
  {
