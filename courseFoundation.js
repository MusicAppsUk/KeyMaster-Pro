...
export const FOUNDATION_STEPS = [
  ...
  },
  {
    ...
    hint: 'Two notes a step apart \u2014 play the lower one, then the note just above it.',
  },
  {
    ...
    hint: 'Two notes a skip apart \u2014 play the lower, then jump over one to the next line.',
  },
  {
    ...
    hint: 'The same note, twice \u2014 play that note, then play it once more.',
  },
  {
    ...
    hint: 'Read it as a shape: down a step, the same note again, then skip down to G.',
  },
  {
