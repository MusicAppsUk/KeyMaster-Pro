...
export const STAGE1_MAKING_STEPS = [
  ...
  },
  {
    ...
    show: { kind: 'keys', midis: [59, 61, 63], caption: '1 on B, 2 on C\u266F, 3 on D\u266F.', label: 'B  C\u266F  D\u266F' },
    staffHint: { clef: 'treble', notes: [59, 61, 63] },
    handHint: { hand: 'right', highlight: [1, 2, 3] },
    demo: [59, 61, 63], demoGap: 0.5,
    tryPrompt: 'Right hand: play B, then C\u266F, then D\u266F (fingers 1, 2, 3).', targets: [59, 61, 63], mode: 'sequence',
  ...
  },
  {
    ...
    show: { kind: 'keys', midis: [47, 49, 51], caption: '4 on B, 3 on C\u266F, 2 on D\u266F.', label: 'B  C\u266F  D\u266F' },
    staffHint: { clef: 'bass', notes: [47, 49, 51] },
    handHint: { hand: 'left', highlight: [4, 3, 2] },
    demo: [47, 49, 51], demoGap: 0.5,
    tryPrompt: 'Left hand: play B, then C\u266F, then D\u266F (fingers 4, 3, 2).', targets: [47, 49, 51], mode: 'sequence',
