...
import './voiceTest.js?v=rc2-192';  // visible Voice Self-Test at #voice-test (no console needed)
import './pwaUpdate.js?v=rc2-192';  // installable-PWA "Update available" flow
...
const VIEW_REGISTRY = {
  ...
  foundations: {
    slot: 'foundations',
    src: './foundations.js?v=rc2-192',
    load: () => import('./foundations.js?v=rc2-192'),
  },
  scales: {
    slot: 'scales',
...
class KeyMasterApp {
  ...
  _openCourseMap() {
    ...
    import('./foundations.js?v=rc2-192').then((F) => {
