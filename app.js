...
import './voiceTest.js?v=rc2-125';  // visible Voice Self-Test at #voice-test (no console needed)
import './pwaUpdate.js?v=rc2-125';  // installable-PWA "Update available" flow
...
const VIEW_REGISTRY = {
  foundations: {
    slot: 'foundations',
    src: './foundations.js?v=rc2-125',
    load: () => import('./foundations.js?v=rc2-125'),
  },
  scales: {
    slot: 'scales',
...
class KeyMasterApp {
  ...
  _openCourseMap() {
    ...
    import('./foundations.js?v=rc2-125').then((F) => {
