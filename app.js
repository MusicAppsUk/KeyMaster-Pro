...
import './voiceTest.js?v=rc2-120';  // visible Voice Self-Test at #voice-test (no console needed)
...
const VIEW_REGISTRY = {
  foundations: {
    slot: 'foundations',
    src: './foundations.js?v=rc2-120',
    load: () => import('./foundations.js?v=rc2-120'),
  },
  scales: {
    slot: 'scales',
...
class KeyMasterApp {
  ...
  _openCourseMap() {
    ...
    import('./foundations.js?v=rc2-120').then((F) => {
