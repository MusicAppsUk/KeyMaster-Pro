...
const VIEW_REGISTRY = {
  ...
  foundations: {
    slot: 'foundations',
    src: './foundations.js?v=rc2-210',
    load: () => import('./foundations.js?v=rc2-210'),
  },
  scales: {
    slot: 'scales',
...
class KeyMasterApp {
  ...
  /**
   * rc2-210: reliable jump to a specific Course lesson (e.g. Course Map -> Key Level 1).
  ...
  async _goToLearnLesson(idx) {
    try { unlockAudio(); } catch { /* rc2-210: resume audio in this nav gesture so the lesson demo isn't blocked by autoplay suspension */ }
  ...
  _openCourseMap() {
    ...
    import('./foundations.js?v=rc2-210').then((F) => {
    ...
    if (isAudioSupported()) {
      ...
      this.piano = {
        ...
        noteOn: (m, v, t) => {
          ...
          // rc2-210: BLUNT, UNCONDITIONAL boundary counter -- proves whether KL1 demo
          ...
          // rc2-210: KL1 demo SINGLE-TRIGGER guard at the FINAL note-output boundary.
