...
export const COURSE_CHAPTERS = [
  ...
  { course: 'keymaster', stage: 1, name: 'Rests \u2014 the Spaces in Music', ids: ['kl1-rests-intro', 'kl1-rests-play'],
  ...
  { course: 'keymaster', stage: 1, name: 'The Left Hand', ids: ['kl1-lh-intro', 'kl1-lh-play'],
    intro: 'The left hand joins, reading the bass clef \u2014 the lower notes below Middle C. Both hands can read music now.' },
  { course: 'keymaster', stage: 1, name: 'Two Hands, Carefully', ids: ['kl1-hands-intro', 'kl1-hands-play'],
  ...
  { course: 'keymaster', stage: 1, name: 'Fingering and Touch', ids: ['kl1-finger-why', 'kl1-finger-play'],
    intro: 'Why the finger numbers matter \u2014 and a first smooth, connected legato touch that makes a line sing.' },
  { course: 'keymaster', stage: 1, name: 'Intervals and Musical Distance', ids: ['kl1-intervals-intro', 'kl1-intervals-play'],
  ...
  { course: 'keymaster', stage: 1, name: 'Five-Finger Patterns and First Scales', ids: ['kl1-fivefinger-play'],
    intro: 'The five-finger pattern \u2014 five notes, five fingers, the hand staying home. The shape that lives inside so much music.' },
  { course: 'keymaster', stage: 1, name: 'First Harmony', ids: ['kl1-harmony-tonic', 'kl1-harmony-triad'],
  ...
  { course: 'keymaster', stage: 1, name: 'Listening and Echo', ids: ['kl1-echo-task'],
    intro: 'No notation \u2014 pure listening. Hear a short phrase and play it straight back by ear, the deepest musical skill of all.' },
  { course: 'keymaster', stage: 1, name: 'Sight-Reading Micro-Lessons', ids: ['kl1-sight-micro'],
  ...
  { course: 'keymaster', stage: 1, name: 'Key Level 1 Review', ids: ['kl1-review'],
